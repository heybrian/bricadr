...
<meta name="description" content="Comprehensive list of all Chilean stocks traded on American exchanges &mdash; Invest in Chile. Updated <?php echo date("F o");?>." />
...
<div class="container">
  <header>
    ...
    <h4>A list of all Chilean companies traded on U.S. exchanges, sortable by price, P/E, name and industry.<br />
