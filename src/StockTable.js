...
const StockTable = ({ stocks }) => (
  <div className='container'>
    <div className='row bg-primary text-white'>
      <div className='col-1'>ADR Name</div>
      ...
      <div className='col-2 d-none d-sm-block'>Sector</div>
      <div className='col-1 d-none d-sm-block'>Industry</div>
    </div>
    {stocks.map(stock => (
      <div className='row border' key={stock.ticker}>
        <div className='col-1'><a href={stock.url} target="_blank" rel="noreferrer">{stock.name}</a></div>
