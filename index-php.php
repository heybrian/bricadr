  ...
  <div class="column span-18">
    ...
    <table id="bricAdr" class="tablesorter">
      ...
      <tbody>
        ...
        <tr>
          <td><a href="http://www.58.com/" target="_blank">58.com</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=ACTS&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.agriacorp.com/" target="_blank">Agria</a></td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=GRO" target="_blank">GRO</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=GRO&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=AMCN&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>American Lorain</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=ALN" target="_blank">ALN</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=ALN&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>American Oriental Bioengineering</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=AOBI" target="_blank">AOBI</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=AOBI&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=BONA&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.ijinshan.com">Cheetah Mobile</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          <td><a href="http://www.china-acm.com" target="_blank">China Advanced Construction Materials</a></td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=CADC" target="_blank">CADC</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CADC&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>China BAK Battery</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=CBAK" target="_blank">CBAK</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CBAK&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.chinacommercialcredit.com" target="_blank">China Commercial Credit</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=LIWA" target="_blank">CCCR</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CCCR&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=STV&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.chinacnit.com/" target="_blank">China Information Technology</a></td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=CNIT" target="_blank">CNIT</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CNIT&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>China Metro-Rural</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=CNR" target="_blank">CNR</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CNR&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>China Ming Yang Wind Power</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=MY" target="_blank">MY</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=MY&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>China New Borun</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=BORN" target="_blank">BORN</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=BORN&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=NPD&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CNTF&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.cvalve.com/" target="_blank">China Xiniya Fashion</a></td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=XNY" target="_blank">XNY</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=XNY&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>China Zenix Auto</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=ZX" target="_blank">ZX</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=ZX&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CISG&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.csc100.com/" target="_blank">Country Style Cooking</a></td>
          <td><a href="http://finance.yahoo.com/q?s=CCSC" target="_blank">CCSC</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=CCSC&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>Dehaier Medical Systems</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=DHRM" target="_blank">DHRM</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=DHRM&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td>E-Commerce China Dangdang</td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=DANG" target="_blank">DANG</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=DANG&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.e-future.com.cn" target="_blank">e-Future</a></td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=EFUT" target="_blank">EFUT</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=EFUT&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.ehousechina.com" target="_blank">E-House</a></td>
          <td><a href="http://finance.yahoo.com/q?d=t&amp;s=EJ" target="_blank">EJ</a></td>
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=EJ&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=LONG&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=GSI&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
        ...
        <tr>
          <td><a href="http://www.ikanggroup.com" target="_blank">iKang Healthcare</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          <td><a href="http://www.jd.com/" target="_blank">JD.com</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          <td>Leju&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          <td><a href="http://www.lightinthebox.com" target="_blank">Light In The Box</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          <td><a href="http://www.qunar.com/" target="_blank">Qunar</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          <td><a href="http://www.tarena.com.cn" target="_blank">Tarena Intl</a>&nbsp;<span style="color: gold;">&lowast;</span></td>
        ...
        <tr>
          ...
          <?php $curl=curl_init();
			curl_setopt ($curl,CURLOPT_URL,"http://download.finance.yahoo.com/d/quotes.csv?s=TSL&f=l1c1p2rj1y&e=.csv");
			curl_setopt ($curl,CURLOPT_HEADER,0);
			ob_start();
			curl_exec ($curl);
			curl_close ($curl);
